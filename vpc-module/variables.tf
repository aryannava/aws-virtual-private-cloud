...
variable "enable_secrets_manager_endpoint" {
  description = "Should be true if you want to provision a Secrets Manager endpoint to the VPC"
  default     = false
}

variable "enable_logs_endpoint" {
  description = "Should be true if you want to provision a logs endpoint to the VPC"
  default     = false
}
...
variable "enable_execute_api_endpoint" {
  description = "Should be true if you want to provision a API Gateway endpoint to the VPC"
  default     = "false"
}
...
variable "enable_vpn_lambda" {
  description = "add or remvoe the VPN connection lambda"
  default     = ""
}

variable "region" {
  default     = "ca-central"
  description = "region to spin this up in"
}

variable "account_id" {
  default     = "'"
  description = "The account we are deploying to"
}

variable "vpn_gateway_tags" {
  type        = "map"
  description = "the CSR to map to"

  default = {
    "cpp_transitvpc:preferred-path" = "CSR1"
    "cpp_transitvpc:spoke"          = "true"
  }
}

variable "bucket_name" {
  default     = "transit-vpc-ADD TRANSIST Bucket Name"
  description = "transit vpc bucket name"
}

variable "bucket_prefix" {
  default     = "vpnconfigs_new/"
  description = "transit vpc prefix name"
}

variable "config_file" {
  default     = "transit_vpc_config.txt"
  description = "config file for transit vpc"
}
